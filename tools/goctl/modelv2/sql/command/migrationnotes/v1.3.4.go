...
func migrateBefore1_3_4(dir, style string) error {
	...
	fmt.Println(`It seems like that your goctl has just been upgraded to version 1.3.4 or later, which refactored the code of the modelv2 module. The original XXXmodel.go has been split into XXXmodel_gen.go (read-only) and XXXmodel.go. You just need to follow these steps to complete the migration:
...
func needShow1_3_4(dir, style string) (bool, error) {
	...
	// In addition, it returns true if it contains a modelv2 file extension.
